...
def init(
    ...
    :param mode: Determines the combination of clock polarity and phase - `see online table <https://calliope.cc/programmieren/editoren/python/python-api#spiinit>`_.
